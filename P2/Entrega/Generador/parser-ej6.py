...
puntos_totales = f_en.readline()
puntos_totales = puntos.split("puntos_totales:")[1][:-1]
puntos_ind = f_en.readline()
puntos_ind = puntos_ind.split("puntos_jugador:")[1]
aux = puntos_ind.split(" ")
puntos_jug.append(aux[0].split("[")[1])
puntos_jug.append(aux[1].split("]")[0])
...
"""
f_sal.write("\t\t (>= (puntos-indiv"+ puntos_jug[0].split(":")[0] +") " + puntos_jug[0].split(":")[1] + ")\n")
f_sal.write("\t\t (>= (puntos-indiv"+ puntos_jug[1].split(":")[0] +") " + puntos_jug[1].split(":")[1] + ")\n")
f_sal.write("\t\t (>= (puntos-indiv) " + puntos_totales + ")\n")
f_sal.write("\t     )\n")
f_sal.write("\t)\n")
f_sal.write(")")
